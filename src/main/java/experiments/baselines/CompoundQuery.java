...
public class CompoundQuery {
    ...
    private final ArrayList<String> paraID;
     ...
     */
    public CompoundQuery(String indexDir,
                         String trecCarDir,
                         String outputDir,
                         String dataDir,
    ...
    public static void main(@NotNull String[] args) {
        ...
        try {
            new CompoundQuery(indexDir, trecCarDir, outputDir, dataDir, entityRunFile, entityQrelFile,
