...
public class Experiment4 {
    ...
    private final Map<String, ArrayList<String>> entityQrel;
    ...
    public Experiment4(String entFile, String file1, String file2, String entityQrelFile, String outFile) {
    ...
    public static void main(@NotNull String[] args) {
        ...
        new Experiment4(entityFile, entityWithSalPsgMapFile, entityWithNoSalPsgMapFile, entityQrelsFile, outFile);
    }
}
